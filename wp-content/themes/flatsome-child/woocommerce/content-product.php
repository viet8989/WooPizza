	...
	<div class="product-small box <?php echo flatsome_product_box_class(); ?>">
		<div class="box-image">
			<div class="<?php echo flatsome_product_box_image_class(); ?>">
				<a class="quick-view" data-prod="<?php echo esc_attr( $product->get_id() ); ?>" href="#quick-view" onclick="conolse.log('pizza_view whole');" aria-label="<?php echo esc_attr( $product->get_title() ); ?>">
					<?php
						/**
						 *
