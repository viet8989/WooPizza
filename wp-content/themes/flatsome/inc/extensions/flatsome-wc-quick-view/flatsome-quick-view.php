...
function flatsome_lightbox_button() {
	...
	global $product;
	echo '  <a class="quick-view" data-prod="' . $product->get_id() . '" href="#quick-view" onclick="event.preventDefault(); sessionStorage.setItem(\'pizza_view\', \'paired\'); window.location.hash=\'quick-view\';"><img src="/wp-content/uploads/images/half_pizza.png" /></a>';
}
