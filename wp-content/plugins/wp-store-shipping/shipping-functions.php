            ...
            function render_shipping_fees_page()
            {
                ...
                <div class="wrap">
                    ...
                    <table class="wp-list-table widefat fixed striped">
                        <thead>
                            <tr>
                                <th style="width: 60%;"><?php _e('Ward/Commune', 'wp-store-shipping'); ?></th>
                                <th style="width: 25%;"><?php _e('Shipping Fee', 'wp-store-shipping'); ?></th>
                        ...
                        <tbody>
                            ...
                            if (!empty($shipping_fees)) {
                                ...
                                ?>
                                <tr>
                                    <td colspan="3" style="text-align: center;"><?php _e('No shipping fees configured yet. Click "Add New" to get started.', 'wp-store-shipping'); ?></td>
                                </tr>
                                <?php
                            }
                            ?>
